<div x-data="{deleteId: @entangle('deleteId').defer, deleteName: null}">
    <x-table.x :paginator="$contests" searchable>
        ...
        @foreach($contests as $contest)
            <x-table.body.row :stripe="$loop->even" :border="!$loop->last">
                ...
                <x-table.body.cell>{{ $contest->start_time->format('H:i') }}</x-table.body.cell>
                <x-table.body.cell>{{ $contest->end_time->format('H:i') }}</x-table.body.cell>

                <x-table.body.cell>
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.contest.contest.edit', $contest) }}">
    ...
    <x-modal.x
        ...
        <x-form.x>
            ...
            <x-form.input.x
                ...
                :model="\App\Models\Components\Modeled\Model::livewire('start_time', \App\Models\Components\Modeled\Livewire\LivewireUpdate::Defer)" />
    ...
    <x-modal.confirm id="deleteContest">
