<div x-data="{
        deleteId: @entangle('deleteId').defer,
        deleteName: null,
        updateId: @entangle('updateId').defer,
        updateSponsor: @entangle('updateSponsor').defer
    }">
    ...
    <x-modal.x
        ...
        <x-form.x>
            ...
            <x-form.input.checkbox
                id="createSponsor.on_canvas"
                :model="\App\Models\Components\Modeled\Model::livewire('createSponsor.on_canvas', \App\Models\Components\Modeled\Livewire\LivewireUpdate::Defer)">
    ...
    <x-modal.x
        ...
        <x-form.x>
            <x-form.input.x
                ...
                :model="\App\Models\Components\Modeled\Model::alpineJs('updateSponsor.name')" />

            <x-form.input.x
                id="updateSponsor.url" label="URL"
                :model="\App\Models\Components\Modeled\Model::alpineJs('updateSponsor.url')" />

            <x-form.input.select
                id="updateSponsor.background" label="Hintergrund"
                :model="\App\Models\Components\Modeled\Model::alpineJs('updateSponsor.background')"
                :options="[
                    ['value' => 'light', 'name' => 'Hell'],
                    ['value' => 'dark', 'name' => 'Dunkel'],
                ]" />
            ...
            <x-form.input.checkbox
                id="updateSponsor.on_canvas"
                :model="\App\Models\Components\Modeled\Model::alpineJs('updateSponsor.on_canvas')">
                Auf Leinwand anzeigen
            </x-form.input.checkbox>
