<form class="space-y-6" action="#">
    ...
    <div>
        <label for="displayname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Anzeigenamen</label>
        <select id="displayname" @error('displayname') aria-describedby="displayname-error" @enderror
    ...
    <button type="submit" wire:click.prevent="login" wire:loading.attr="disabled" wire:target="login"
