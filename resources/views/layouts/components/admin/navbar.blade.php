<nav
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="{{ route('public.home') }}" class="flex items-center">
            <img src="{{ asset('storage/img/' . (theme()?->images ?? 'backup') . '/logo/dark-text.svg') }}" class="h-6 mr-3 sm:h-9 dark:hidden" alt="Codemania">
            <img src="{{ asset('storage/img/' . (theme()?->images ?? 'backup') . '/logo/light-text.svg') }}" class="h-6 mr-3 sm:h-9 hidden dark:inline" alt="Codemania">
        </a>
