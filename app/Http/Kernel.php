...
use App\Http\Middleware\Auth\NotTwoFactorAuthenticated;
use App\Http\Middleware\Auth\RequiresTwoFactorEnabled;
use App\Http\Middleware\Auth\TwoFactorAuthenticated;
...
use App\Http\Middleware\Verification\EmailNotVerified;
